...
namespace BW
{
  ...
  static_assert(offsetof(CSprite, width) == 0x12, "CSprite member not at correct offset");
  static_assert(offsetof(CSprite, height) == 0x13, "CSprite member not at correct offset");
